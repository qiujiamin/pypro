...
class OperationExcel:
    def __init__(self,file_name=None,sheet_id=None):
        ...
        if file_name:
            ...
            # self.file_name = '../dataconfig/all.xls'
            self.file_name = '../dataconfig/buylotto.xls'
            self.sheet_id = 0
        self.data = self.get_data()
    # 拿出excel数据
    # 获取sheets的内容
    def get_data(self):
        # dataconfig = xlrd.open_workbook('../dataconfig/mltesttest.xlsx')
...
if __name__ == '__main__':
    # opers = OperationExcel('../dataconfig/mltest8.xlsx',0)
    opers = OperationExcel("../dataconfig/all.xls")
    # opers.get_data()
    # print(opers.get_data().nrows)
    # print(opers.get_data())
    # print(opers.get_lines())
    # print(opers.get_cell_value(1,6))
    # print(opers.get_row_num('mm-02'))
